  ...
  return (
    <div className="space-y-5 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-xs text-slate-400 mt-0.5">Employee groups and preferences</p>
      </div>

      <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
        <div className="px-4 py-2.5 border-b border-slate-100">
          <h2 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Group Assignment</h2>
          <p className="text-[11px] text-slate-400 mt-0.5">Malta Office = 4-day office policy. Remote = hours only.</p>
        </div>
