...
export async function PATCH(req: NextRequest) {
  const { id, first_name, last_name, talexio_id, unit, group_type, job_schedule, position, excluded, timezone } = await req.json()
  ...
  if (timezone !== undefined) updates.timezone = timezone || 'Europe/Malta'
